...
export default function LessonsPage() {
    ...
    // ─── Render ───
    const getBankTitle = (bank: QuestionBankData) => (bank.title as any)?.ar || 'درس';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/70 text-sm">
                                {stats.totalQuestions} سؤال في {stats.totalBanks} درس
                            </p>
                        </div>
                    </div>
                    <Link
                ...
                <div className="bg-white dark:bg-[#1c1c24] rounded-xl p-4 border border-gray-200 dark:border-[#2e2e3a]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">إجمالي الدروس</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="space-y-4">
                {isLoading ? (
                    <div className="flex justify-center py-20">
                        <LoadingSpinner size="lg" text="جاري تحميل الدروس..." />
                    </div>
                ) : questionBanks.length === 0 ? (
                    <NoQuestionsFound onCreateQuestion={() => window.location.href = '/admin/lessons/create'} />
                ) : (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2">
                                    <Link
                                        href={`/admin/lessons/edit/${bank.id}`}
