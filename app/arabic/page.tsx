                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white mb-1">
                                        اللغة <span className="bg-gradient-to-r from-primary-600 to-pink-500 dark:from-primary-400 dark:to-pink-400 bg-clip-text text-transparent">العربية</span>
                                    </h1>
                            ...
                            {activeTab === "lessons" ? (
                                isLoading ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400 text-lg">لا توجد دروس لهذه المرحلة حالياً</p>
                                    </motion.div>
                                ) : (
                                    <motion.div
                                        key="lessons"
                                ...
                                isLoading ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400 text-lg">لا توجد امتحانات لهذه المرحلة حالياً</p>
                                    </motion.div>
                                ) : (
                                    <motion.div
                                        key="exams"
                                    ...
                                    >
                                        {exams.map((exam) => (
                                            <motion.div key={exam.id} variants={itemVariants}>
                                                <Link href={`/arabic/exam/${exam.id}`} className="block group h-full">
                                                        ...
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            <div className="min-w-0 flex-1">
                                                                ...
                                                                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-1 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                                                    {typeof exam.title === 'object' ? (exam.title as any).ar || '' : exam.title}
                                                                </h3>
                                                                <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mb-2">
                                                                    {typeof exam.description === 'object' ? (exam.description as any).ar || '' : exam.description || ''}
                                                                </p>
