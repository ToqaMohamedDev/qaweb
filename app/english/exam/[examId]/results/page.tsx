...
export default function ExamResultsPage() {
    ...
    // For English exams, passing score might be set, but let's assume total marks logic similar to Arabic for visual consistency
    // If total marks isn't set, we might need to calculate it from sections, but for now fallback to 0 or manual check
    const total = 100; // Placeholder if not in DB schema explicitly for English, but we added total_marks column
