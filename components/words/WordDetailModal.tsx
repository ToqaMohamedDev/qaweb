...
export function WordDetailModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal */}
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl bg-zinc-950 border border-zinc-800 shadow-2xl">
                {/* Header */}
                ...
                <div className="overflow-y-auto max-h-[calc(90vh-80px)] p-4 space-y-6">
                    ...
                    {/* Language Tabs */}
                    <div className="flex gap-2 p-1 rounded-xl bg-zinc-900 overflow-x-auto scrollbar-hide">
                    ...
                    {currentEntry && (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-zinc-800">
                                <div>
